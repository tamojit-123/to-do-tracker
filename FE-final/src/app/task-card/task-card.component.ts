...
export class TaskCardComponent implements OnInit {
  ...
  constructor(private modal: NgbModal, private formBuilder: FormBuilder, private managerService: TaskManagerService, private tasksComp: TasksComponent) { }
  ...
  updateTask() {
    ...
    let updatedTask: Task = new Task(this.task.taskID, this.taskForm.value.title, this.taskForm.value.desciption, this.taskForm.value.dueDate, 
                          this.taskForm.value.priorityLevel, this.taskForm.value.category)
    this.managerService.updateTask(this.currentUserID, this.task.taskID, updatedTask).subscribe(res => console.log(res))
