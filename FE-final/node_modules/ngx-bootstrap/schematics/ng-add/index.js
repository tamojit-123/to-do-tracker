...
function addPackageJsonDependencies(host, context) {
    const dependencies = getVersions_1.getDependencies(host);
...
function insertBootstrapStyles(project, host, projectName, extension) {
    ...
    return addStyles_1.addStyles(project, 'build', host, BOOTSTRAP_AVAILABLE_STYLES, projectName, extension);
}
function insertCommonStyles(project, host, projectName, extension) {
    ...
    return addStyles_1.addStyles(project, 'build', host, DATEPICKER_AVAILABLESTYLES, projectName, extension);
}
