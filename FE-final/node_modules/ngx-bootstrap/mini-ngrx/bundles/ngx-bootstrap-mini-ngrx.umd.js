(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-bootstrap'] = global['ngx-bootstrap'] || {}, global['ngx-bootstrap']['mini-ngrx'] = {}), global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var MiniState = /** @class */ (function (_super) {
        ...
        function MiniState(_initialState, actionsDispatcher$, reducer) {
            ...
            var state$ = actionInQueue$.pipe(operators.scan(function (state, action) {
                if (!action) {
                    return state;
                }
