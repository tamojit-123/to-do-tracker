(function (global, factory) {
    ...
    */
    ...
    function configFromArray(config) {
        ...
        var currentDate = currentDateArray(config);
        ...
        var expectedWeekday = config._useUTC ? config._d.getUTCDay() : config._d.getDay();
    ...
    function dayOfYearFromWeekInfo(config) {
        var weekYear, week, weekday, dow, doy, temp, weekdayOverflow;
        var w = config._w;
    ...
    var ɵ0$3 = function (months, monthsShort) {
        var i, _monthsParse = [];
        for (i = 0; i < 12; i++) {
